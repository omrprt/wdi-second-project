  ...
  return Game.create([
    {
      ...
      image: 'https://cf.geekdo-images.com/images/pic1081488.jpg',
      description: 'Star Trek Fleet Captains puts the entire Federation or Klingon fleet at your disposal as you fight for control over a sector of unexplored space. Encounter new civilizations, expand your influence by establishing an outpost or a starbase, and complete missions to secure your victory!',
      playingTime: '75-75 Minutes',
      players: '2-4',
      genre: 'Fighting, Miniatures, Movies / TV / Radio theme, Science Fiction, Space Exploration',
      ...
      image: 'https://cf.geekdo-images.com/images/pic3008535.jpg',
      ...
      players: '1-4',
      genre: 'Movies / TV / Radio theme, Science Fiction, Space Exploration',
      designer: 'Vlaada Chv·til, Andrew Parks'
    }, {
      title: 'Agricola',
      image: 'https://cf.geekdo-images.com/images/pic259085.jpg',
      description: 'Agricola is a Euro-style board game created by Uwe Rosenberg. It is a worker placement game with a focus on resource management. In Agricola, players are farmers that sow, plow the fields, collect wood, build stables, buy animals, expand their farms and feed their families. After 14 rounds players calculate their score based on the size and prosperity of the household.',
      playingTime: '30-150 Minutes',
      players: '1-5',
      genre: 'Animals, Economic, Farming',
      designer: 'Uwe Rosenberg'
    }, {
      title: 'War of the Ring (Second Edition)',
      image: 'https://cf.geekdo-images.com/images/pic1215633.jpg',
      ...
      playingTime: '150-180 Minutes',
      players: '2-4',
      genre: 'Adventure, Dice, Fantasy, Miniatures, Novel-based, Territory Building',
      ...
      image: 'https://cf.geekdo-images.com/images/pic1365413.jpg',
      description: 'Space ... The final frontier ... Star Trek Catan combines the adventures of the legendary Starship Enterprise with those of the settlers of Catan. The challenge is to settle a world that has never been settled before.',
      playingTime: '75-75 Minutes',
      players: '3-4',
      genre: 'Movies / TV / Radio theme, Negotiation, Science Fiction',
      designer: 'Klaus Teuber'
    }, {
      title: 'Puerto Rico',
      image: 'https://cf.geekdo-images.com/images/pic158548.jpg',
      description: 'Players assume the roles of colonial governors on the island ofPuerto Rico during the age of Caribbean ascendancy. The aim of the game is to amass victory points by exporting goods or by constructing buildings. Puerto Rico can be played by three to five players, although an official two player variant also exists.',
      playingTime: '90-150 Minutes',
      players: '2-5',
      genre: 'City Building, Economic, Farming',
      ...
      title: 'Blood Rage',
      image: 'https://cf.geekdo-images.com/images/pic2439223.jpg',
      description: 'Blood Rage is a Viking themed board game designed by Eric Lang and published by CoolMiniOrNot in 2015. Each player controls a clan of mythological Vikings seeking glory as Ragnarok approaches. Played in three ages or rounds, Blood Rage features card drafting, battles and territory control via forces represented by sculpted plastic miniatures. All conflicts are resolved through playing cards, and cards are also used to improve and differentiate the different clans and the leaders, warriors, ships and monsters at their command.',
      playingTime: '60-90 Minutes',
      players: '2-4',
      genre: 'Fantasy, Fighting, Miniatures, Mythology',
...
}).then((games) => console.log(`${games.length} games created`)).catch((err) => console.log(err)). finally(() => mongoose.connection.close());
